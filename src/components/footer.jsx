      ...
      <div className="container my-3">
        <div className="footer-groups">
          ...
          >
            ...
            <p className="mt-5">
              <Link to="mailto:info@onmed.com" className="link-no-underline">
                info@onmed.com
              </Link>
              <br />
              (727) 601-4513
          ...
          <div className="footer--group-social-media mt-5 mt-md-3">
            <div className="footer--social-media">
              <Link to="https://www.facebook.com/OnMedStation/" target="_blank">
                <img
              ...
              <Link to="https://twitter.com/onmedstation" target="_blank">
                <img
